= OciWebPOS: Technical Documentation
aTec - SEPTI - Tecnologies Comercials
include::basics.ad[]

// Refs
:ocicommerce-app-des-ref: http://lxapldes3.xarxa.interna:8080/OciCommerce/
:ocicommerce-app-int-ref: http://lxaplint3.xarxa.interna:8080/OciCommerce/
...
This document explains how to set up and run the OciWebPOS application based on a Single Page Web App arquitecture stack.
